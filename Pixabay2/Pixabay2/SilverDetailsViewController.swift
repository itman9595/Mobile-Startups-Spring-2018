//
//  SilverDetailsViewController.swift
//  Pixabay2
//
...
class SilverDetailsViewController: UIViewController, UIScrollViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let shareBtn = UIBarButtonItem(image: UIImage(named: "share"), style: .plain, target: self, action: #selector(SilverDetailsViewController.share))
