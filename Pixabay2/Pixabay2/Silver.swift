...
class Silver: UIViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if (segue.identifier == "DetailsSegue") {
            let vc = segue.destination as! SilverDetailsViewController
...
extension Silver: UISearchBarDelegate, UISearchControllerDelegate {
...
extension Silver: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
